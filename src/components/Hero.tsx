...
export function Hero() {
  ...
  return (
    <div
      // style={heightStyle}
      className="bg-hero-bg bg-cover h-[100vh] bg-center flex justify-center flex-grow"
    >
      <div className="h-fit font-playfair font-bold bg-code-gray-700 bg-opacity-20 mt-14 p-3 text-3xl text-code-gray-800">
