...
import { useCart, useCurrentPage, useCheckout, useFormStep } from '../hooks/hooks';
import { CartItemCard } from './CartItemCard';
import { FormSteps } from '../helpers/types';

export function Cart({ setDrawerIsOpen }: { setDrawerIsOpen: (isOpen: boolean) => void }) {
  const { cart } = useCart();
  ...
  return (
    <>
      ...
      <form
        onSubmit={handleSubmit((promoCode) => applyDiscount(promoCode.promoCode))}
