  ...
  return (
    <>
      ...
      <Drawer drawerIsOpen={drawerIsOpen} setDrawerIsOpen={setDrawerIsOpen}>
        <div className='w-full h-full flex flex-col justify-between pb-28'>
          <div className='overflow-y-scroll p-2'>
            <div className='relative flex flex-col justify-between items-start w-full'>
              <div
                className='w-full bg-cover bg-no-repeat bg-center h-[45vh] min-h-[20rem] shadow-md rounded-lg transition-all'
          ...
          <div
            id='bottom-summary'
            className='fixed bottom-0 right-0 w-full max-w-md bg-white rounded-t-3xl px-3 pt-5 pb-8 flex justify-between shadow-top-xl'>
